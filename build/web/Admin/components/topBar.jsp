<%-- 
    Document   : topBar
    Created on : Jun 26, 2020, 8:16:46 PM
    Author     : Admin
--%>
...
<nav class="topBar shadowed d-flex justify-content-center">
    <!-- search bar -->
    <form
        class="d-none d-sm-inline-block form-inline mr-auto ml-3 navbar-search"
        _lpchecked="1"
        >
    ...
    <!-- Notification -->
    <ul class="navbar-nav ml-2 d-flex flex-row align-items-center">
        ...
        <li class="nav-item dropdown no-arrow noti">
            <a
                class="nav-link dropdown-toggle"
                href="#"
                id="userDropdown"
