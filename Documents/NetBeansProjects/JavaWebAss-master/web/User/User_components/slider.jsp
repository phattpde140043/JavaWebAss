        ...
        <div id="carouselExampleIndicators" class="carousel slide p-5" data-ride="carousel" data-pause="hover" data-interval="5000">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="row d-flex justify-content-center">
                        <a href="#" class="col-xs-6 col-md-6 col-lg-2 p-0 d-flex justify-content-center">
                            <img src="User_img/1.jpg" alt="" class="w-100">
                        </a>

                        <a href="#" class="col-xs-6 col-md-6 col-lg-2 p-0 d-flex justify-content-center">
                            <img src="User_img/2.jpg" alt="" class="w-100">
                        </a>

                        <a href="#" class="col-xs-6 col-md-6 col-lg-2 p-0 d-flex justify-content-center">
                            <img src="User_img/3.jpg" alt="" class="w-100">
                        </a>

                        <a href="#" class="col-xs-6 col-md-6 col-lg-2 p-0 d-flex justify-content-center">
                            <img src="User_img/4.jpg" alt="" class="w-100">
                        </a>

                        <a href="#" class="col-xs-6 col-md-6 col-lg-2 p-0 d-flex justify-content-center">
                            <img src="User_img/5.jpg" alt="" class="w-100">
                        </a>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="row d-flex justify-content-center">
                        <a href="#" class="col-xs-6 col-md-6 col-lg-2 p-0 d-flex justify-content-center">
                            <img src="User_img/6.jpg" alt="" class="w-100">
                        </a>
                        ...
                        <a href="#" class="col-xs-6 col-md-6 col-lg-2 p-0 d-flex justify-content-center">
                            <img src="User_img/10.jpg" alt="" class="w-100">
                        </a>
                ...
                <div class="carousel-item">
                    <div class="row d-flex justify-content-center">
                        ...
                        <a href="#" class="col-xs-6 col-md-6 col-lg-2 p-0 d-flex justify-content-center">
                            <img src="User_img/8.jpg" alt="" class="w-100">
                        </a>
